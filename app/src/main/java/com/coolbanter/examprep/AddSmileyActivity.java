...
import com.coolbanter.examprep.add.AddViewModel;
import com.coolbanter.examprep.add.AddViewModelFactory;
...
public class AddSmileyActivity extends AppCompatActivity implements TextWatcher {
    ...
    public void saveOnClick(View view) {
        ...
        if (emoji.length() == 0) {
            ...
            String unicode = mUnicode.getText().toString();
            mViewModel.getUnicode().postValue(unicode);
